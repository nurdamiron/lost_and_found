    ...
    <div className="mx-auto border border-gray-100 dark:border-midnight-200 bg-white dark:bg-midnight-400 rounded-xl shadow-md overflow-hidden md:max-w-2xl w-full">
      <div className="md:flex justify-around">
        ...
        <div className="p-4 w-full">
          ...
          <div>
            <div>
              <span className="text-sm dark:text-gray-300 bold">
                Reported By:{" "}
              </span>
              <span className="text-sm dark:text-gray-300 text-semibold">
                Nurdaulet
              </span>
            </div>
        ...
        <div className="md:shrink-0">
          <div className="text-xs text-gray-500 dark:text-100 h-1/6 w-full text-right px-4 pt-2">
            Lost on: 17 November, 2023
          </div>
          <div className="flex items-center justify-center h-5/6">
            <img
              className="h-30 px-4 pb-4 pt-1 w-full object-cover md:w-40"
              src="./profile2.jpg"
