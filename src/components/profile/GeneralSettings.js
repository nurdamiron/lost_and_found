  ...
  return (
    <Form method="post" action="route('user.updateProfile')" file="true">
      <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
        <div className="w-full px-4 mb-4 md:mb-0 md:w-1/2">
          ...
          >
            ...
            >
              <FontAwesomeIcon
                className="rounded-full text-white bg-blue-600 absolute fa-pencil cursor-pointer"
                style={{
                  fontSize: "12px",
                  padding: "8px",
                  right: "-72px",
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          className="right-0 inline-block py-1 px-4 leading-loose bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg transition duration-200 text-sm"
        >
          Save Changes
        </button>
      </div>
